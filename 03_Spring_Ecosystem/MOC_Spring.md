# 🗺️ Map of Content: Spring Framework & Ecosystem
#moc #spring #architecture

### 🎯 Зона ответственности домена
Понимание жизненного цикла компонентов, механизмов инверсии управления (IoC/DI), реализации сквозной логики через AOP-прокси и работы сетевых стеков.

### 🌿 Внутренние связи (Core Links)
*   [[Spring_IoC_and_Lifecycle]] — Конвейер создания бинов, BPP и запрет циклических зависимостей в Spring Boot 3.x.
