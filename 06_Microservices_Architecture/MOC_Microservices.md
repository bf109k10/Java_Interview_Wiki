# 🗺️ Map of Content: Microservices Architecture
#moc #microservices #cloud-native

### 🎯 Зона ответственности домена
Шаблоны проектирования распределенных систем, обеспечение отказоустойчивости (Fault Tolerance) на стыке сервисов, безопасность и транзакционная целостность.
